...
public class ConditionString {
        ...
        if(model!=null){
            ...
            if(!CollectionUtils.isEmpty(conditions)){
                for(Condition condition : conditions){
                    ...
                    if(model.getParams()!=null && StringUtils.isNotBlank(model.getParams().get(field))){
    ...
    public String getDslQuery(){
        ...
        dsl+=  "      ]\n" +
                "    }\n" +
                "  }\n";
        if(model.getSort()!=null&&(model.getSort().getStatus().equals(0)||model.getSort().getStatus()==null)){
